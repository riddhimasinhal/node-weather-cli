...
This app uses Nominatim for geocoding (city to coordinates) and Open-Meteo for weather data (temperature, humidity, wind speed, precipitation probability). No API key required.
